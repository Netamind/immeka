...
<table id="suppliers-table" class="table table-striped-column  table-sm table-striped table-fixed-first-column table-fixed-header" >
<thead class="table-dark">
<tr>
<th class="table-dark">SupplierName</th>
...
<tr id="{{$row}}">
   ...
   <td style="text-align:center">
    <?php
    $category = DB::table('businesscategories')->where('id',$d->category)->value('category');
    ?>
   {{$category}}
  </td>
   ...
   <td style="text-align:center">{{$d->email}}</td>
    ...
    <i class="fa fa-edit text-primary fa-2x" ></i>
		...
		<a href="#" class="deleteDataBtnClass" deleteLabel="{{$d->supplier}}"  deleteId="{{$d->id}}" deleteRow="{{$row}}">
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="newDataModal" data-bs-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="insert-supplier" method="post"  enctype="multipart/form-data" id="newDataForm">
			@csrf
      ...
      <a href="#" class="btn btn-secondary" style="float:right;margin-right:10px"  id="cancelDataBtn">Cancel</a> 
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="editDataModal" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="edit-supplier" method="post"   id="editDataForm">
			@csrf
