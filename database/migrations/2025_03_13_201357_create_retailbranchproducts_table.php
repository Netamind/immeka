...
class CreateRetailbranchproductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('retailbranchproducts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('retailbranchproducts');
    }
}
