...
<table id="retailclients-table" class="table table-striped-column  table-sm table-striped table-fixed-first-column table-fixed-header" >
...
<tbody id="tbody">
<?php
$data  = DB::table('retailclients')->get();
?>
@foreach($data as $d)
<?php $row = "row".$d->id;?>
<tr id="{{$row}}">
   ...
   <td style="text-align:center">{{$d->date}}</td>
    ...
    <i class="fa fa-edit text-primary fa-2x" ></i>
		...
		<a href="#" class="deleteDataBtnClass" deleteLabel="{{$d->client}}"  deleteId="{{$d->id}}" deleteRow="{{$row}}">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="insert-retail-client" method="post"  id="newDataForm">
			@csrf
      <div class="row">
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="editDataModal" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="edit-retail-client" method="post"   id="editDataForm">
			@csrf
      ...
      <div class="col-md-12 form-group">
        <label for="#">Client Name</label>
         <input type="text" name="client" class="form-control" id="editclient" >
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
		...
		<h4 style="paddin-top:10px;padding-bottom:10px">Are you sure you want to delete <span id="displayDeleteItem"></span> ?</h4>
		   ...
		   <form action="delete-wholesale-client" method="post" id="deleteForm">
			@csrf
...
$('#submitDataBtn').click(function(e) {
    ...
    $('#tbody').on('click', '.editDataBtnClass', function() {
      ...
      $('#editclient').val($(this).attr('editclient'));
