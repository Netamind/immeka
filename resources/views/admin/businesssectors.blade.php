...
<table id="sectors-table" class="table  table-sm table-striped-column   table-striped table-fixed-first-column table-fixed-header" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header ">
        <h5 class="modal-title">Important Notice: Adding New Sector</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      As an administrator, you do not have the authority to create new sectors within the system. The available sectors are pre-defined and managed by our development team. If you identify a need for an additional sector, please reach out to our development team. We will be happy to assist you in adding the necessary sector to the system.
      <br> <br>
      </div>
    </div>
  </div>
