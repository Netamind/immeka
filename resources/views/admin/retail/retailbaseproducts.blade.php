...
<table id="retailproducts-table" class="table table-striped-column  table-sm table-striped table-fixed-first-column table-fixed-header" >
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="newDataModal" data-bs-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="insert-retail-baseproduct" method="post"  enctype="multipart/form-data" id="newDataForm">
			@csrf
...
$('#retailproducts-table').DataTable({ 
     dom: 'Bfrtip', 
     autoWidth:false,
     paging: true,
     pageLength: -1,
...
$.ajax({
    type: "post",
    url: '/upload-retail-baseproducts-csvfile',
    data: { data: data },
    timeout: 60000,
    beforeSend: function() {
        $('#loading-status').css('display', 'block');
